...
// Wyprowadzenia
#define OWI_PORT			(PORTC)	/*!< Rejestr wyjściowy 1-Wire */
#define OWI_DDR				(DDRC)	/*!< Rejestr kierunkowy 1-Wire */
#define OWI_PIN				(PINC)	/*!< Rejestr wyjściowy 1-Wire */
#define OWI					(_BV(7))/*!< Maska wyprowadzenia 1-Wire */
